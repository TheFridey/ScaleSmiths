...
export function assertIsolatedAdminTestDatabase(databaseUrl, environmentMarker) {
  if (environmentMarker !== "forge-v2-e2e") {
    throw new Error("SCALESMITHS_TEST_ENVIRONMENT=forge-v2-e2e is required.")
  }
  if (!databaseUrl) throw new Error("An isolated ADMIN_DATABASE_URL is required.")
