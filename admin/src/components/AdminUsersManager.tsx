...
export function AdminUsersManager({ initialUsers, actorRole }: { initialUsers: UserRow[]; actorRole: AdminRole }) {
  ...
  return <div className="mx-auto max-w-6xl space-y-6 p-3">
    <div><h1 className="font-syne text-3xl font-bold">Admin users</h1><p className="mt-1 text-sm text-t2">Internal identities, roles, status and session revocation.</p></div>
