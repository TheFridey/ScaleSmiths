...
export function PortalUsersManager({ initialUsers, clients }: { initialUsers: PortalUserRow[]; clients: ClientOption[] }) {
  ...
  return <section className="rounded-xl border border-b1 bg-s1 p-4 sm:p-5">
    ...
    <form onSubmit={create} className="mt-5 grid gap-3 rounded-xl border border-b1 bg-s2 p-4 lg:grid-cols-[1.2fr_1.3fr_1fr_auto] lg:items-end">
