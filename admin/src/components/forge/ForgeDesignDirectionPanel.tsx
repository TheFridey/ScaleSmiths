...
export function ForgeDesignDirectionPanel({
  ...
  const [selectedStylePack, setSelectedStylePack] = useState<ForgeDesignStylePack>(initialDirection?.selectedStylePack ?? "Clean Local Pro")
  ...
  useEffect(() => {
    ...
    setSelectedStylePack(nextDirection?.selectedStylePack ?? "Clean Local Pro")
