...
describe("downstream invalidation uses the active run's mode and policy", () => {
  it("migration-mode invalidation uses the migration policy", () => {
  ...
  it("refresh-mode invalidation uses the refresh policy", () => {
  ...
  it("a skipped stage remains skipped when unrelated upstream artifacts change", () => {
    const policy: ForgeRunPolicy = {}
  ...
  it("changed approved copy invalidates design and downstream output", () => {
    const policy: ForgeRunPolicy = {}
    const selected = selectStagesToInvalidate({
      changedStage: "copy",
      steps: [
  ...
  it("changed design does not invalidate approved research or copy", () => {
    const policy: ForgeRunPolicy = {}
    const selected = selectStagesToInvalidate({
