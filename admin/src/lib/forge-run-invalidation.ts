 ...
 * new output.
 *
 * Pure and policy-aware on purpose. Invalidation previously evaluated every run against a
 * hardcoded standard mode and empty policy, so redesign, refresh and migration runs were
 * judged against a run that was not executing.
 */
