...
export const CAPABILITIES = [
  ...
  "venture.integration.manage", "venture.emergency_stop", "venture.audit.read",
] as const
...
export function requiredCapabilityForRequest({ pathname, method }: RbacRequest): Capability | null {
  ...
  if (pathname === "/venture-lab" || pathname.startsWith("/venture-lab/")) return "venture.read"
  ...
  if (pathname.startsWith("/operations/analytics-retention") || pathname.startsWith("/api/operations/analytics-retention")) return write ? "analytics.write" : "analytics.read"
