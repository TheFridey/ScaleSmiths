...
| venture_controller | self-service MFA; Venture Lab read/write, finance read/request/approve, experiment manage, launch request/approve, integration manage, emergency STOP, audit read; no unrelated ScaleSmiths admin authority |
