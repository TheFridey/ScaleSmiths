...
| P1 | [#59 Review and exit the Auth.js v5 beta risk acceptance](https://github.com/TheFridey/ScaleSmiths/issues/59) | 2026-09-17 review renewed the `next-auth@5.0.0-beta.32` acceptance to 2027-01-30; migrate when a compatible stable Auth.js/next-auth release exists. | Upstream Auth.js stable v5 or equivalent. |
