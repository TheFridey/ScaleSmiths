...
const policy = {
  reviewedFrameworkVersion: "15.5.20",
  criticalDependencies: {
    web: { next: "15.5.20", "eslint-config-next": "15.5.20", react: "18.3.1", "react-dom": "18.3.1" },
    admin: { next: "15.5.20", "eslint-config-next": "15.5.20", react: "18.3.1", "react-dom": "18.3.1", "next-auth": "5.0.0-beta.31" },
  },
...
function app(dependencies, devDependencies = {}) {
  ...
  packages["node_modules/@next/env"] = { version: "15.5.20" }
  packages["node_modules/@next/eslint-plugin-next"] = { version: "15.5.20" }
  packages["node_modules/@next/swc-linux-x64-gnu"] = { version: "15.5.20" }
...
test("accepts aligned exact framework and authentication versions", () => {
  const web = app({ next: "15.5.20", react: "18.3.1", "react-dom": "18.3.1" }, { "eslint-config-next": "15.5.20" })
  const admin = app({ next: "15.5.20", react: "18.3.1", "react-dom": "18.3.1", "next-auth": "5.0.0-beta.31" }, { "eslint-config-next": "15.5.20" })
...
test("reports unpinned critical dependencies and manifest-lock drift", () => {
  const web = app({ next: "^15.5.20", react: "18.3.1", "react-dom": "18.3.1" }, { "eslint-config-next": "15.5.20" })
  web.lock.packages[""].dependencies.next = "15.5.20"
  const admin = app({ next: "15.5.20", react: "18.3.1", "react-dom": "18.3.1", "next-auth": "5.0.0-beta.31" }, { "eslint-config-next": "15.5.20" })
  const report = inspectDependencyGovernance({ web, admin }, policy)
...
test("reports mismatched Next.js ecosystem and React versions", () => {
  const web = app({ next: "15.5.20", react: "18.3.1", "react-dom": "18.3.1" }, { "eslint-config-next": "15.5.20" })
  web.lock.packages["node_modules/@next/env"].version = "15.5.19"
  const admin = app({ next: "15.5.20", react: "18.2.0", "react-dom": "18.2.0", "next-auth": "5.0.0-beta.31" }, { "eslint-config-next": "15.5.20" })
  const report = inspectDependencyGovernance({ web, admin }, policy)
