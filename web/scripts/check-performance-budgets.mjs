...
const routes = [
  ...
  // One representative of each remaining public archetype, so a regression on a commercial page,
  // an article or a case study is caught rather than inferred from the homepage. These routes are
  // largely static server-rendered content, so their budgets are tighter than the homepage's.
  {
    id: "commercial-landing",
    route: "/web-design-nottingham",
    manifestKey: "/web-design-nottingham/page",
    description: "Commercial landing page (search entry point)",
    hard: {
      routeJsGzipKb: 220,
      initialJsGzipKb: 320,
      transferredKb: 1_200,
    ...
    advisory: { lcpMs: 2_500, totalBlockingMs: 300, performance: 0.85 },
  },
  {
    id: "insight-article",
    route: "/insights/how-much-does-a-business-website-cost-uk-2026",
    manifestKey: "/insights/[slug]/page",
    description: "Insights article (long-form content)",
    hard: {
      routeJsGzipKb: 220,
      initialJsGzipKb: 320,
      transferredKb: 1_000,
    ...
    advisory: { lcpMs: 2_400, totalBlockingMs: 300, performance: 0.85 },
  },
  {
    id: "case-study",
    route: "/work/confirm-a-kill",
    manifestKey: "/work/[slug]/page",
    description: "Flagship case study (image-heavy proof page)",
    hard: {
      routeJsGzipKb: 260,
      initialJsGzipKb: 320,
      transferredKb: 2_200,
    ...
    advisory: { lcpMs: 2_900, totalBlockingMs: 350, performance: 0.80 },
  },
]
