          ...
          <AnimateIn className="mt-10 grid gap-10 lg:grid-cols-[1.15fr_.85fr] lg:items-end">
            ...
            <aside aria-label="Where ScaleSmiths is based" className="rounded-2xl border border-acc/25 bg-acc/[.07] p-6 md:p-8">
              ...
              <p className="mt-5 font-dm text-sm leading-relaxed text-t2">
                We are based in Hucknall, on the northern edge of Nottingham. Local business work sits alongside
                national and international platform builds, with the same focus on useful commercial outcomes.
              </p>
              <p className="mt-4 font-dm text-sm leading-relaxed text-t2">
                Projects are delivered with a communication and review cadence agreed around the work.
              </p>
      ...
      <section aria-labelledby="about-founders" className="px-6 py-16 md:px-12 md:py-24">
        <div className="mx-auto max-w-[1240px]">
          <div className="max-w-3xl">
            ...
            <h2 id="about-founders" className="mt-2 font-syne text-[clamp(30px,4.5vw,48px)] font-extrabold tracking-[-.03em]">Who owns and drives the work.</h2>
            <p className="mt-3 font-dm text-sm leading-relaxed text-t2">
              ScaleSmiths combines commercial growth thinking with hands-on engineering. Both founders stay close to the client relationship and the outcome being built.
            </p>
          </div>
      ...
      <section aria-label="Founder-led call to action" className="px-6 py-20 md:px-12 md:py-24">
        <div className="mx-auto max-w-[760px] rounded-3xl border border-acc/20 bg-gradient-to-br from-s2 to-acc/5 px-8 py-[64px] text-center md:px-16">
          ...
          <p className="mx-auto mt-4 max-w-[460px] font-dm text-base leading-relaxed text-t2">
            Tell us what the business needs to do next. We will tell you what we think is worth fixing, what is not, and where ScaleSmiths can genuinely help.
          </p>
