...
export function renderGlobalErrorFallback(reset: () => void) {
  return createElement("main", { style: { minHeight: "100vh", display: "grid", placeItems: "center", padding: "2rem" } },
    createElement("section", { "aria-labelledby": "global-error-title", style: { maxWidth: 560, textAlign: "center" } },
      createElement("p", { style: { color: "#e8a045", fontWeight: 700, letterSpacing: ".12em", textTransform: "uppercase" } }, "ScaleSmiths"),
      ...
      createElement("button", { type: "button", onClick: reset, style: { marginTop: "1rem", padding: ".75rem 1rem", borderRadius: 8, border: 0, background: "#e8a045", color: "#1a1208", fontWeight: 700, cursor: "pointer" } }, "Try again"),
    ),
  )
}
