      ...
      <PaperBand aria-labelledby="featured-insight">
        <div className="mx-auto grid max-w-[1240px] gap-10 lg:grid-cols-[1.05fr_.95fr] lg:items-center">
          <div>
            ...
            <h2 id="featured-insight" className="paper-display mt-3">{featured.title}</h2>
          ...
          <aside className="surface-chrome rounded-2xl border border-b1 p-7 md:p-9">
            <p className="font-syne text-xl font-bold tracking-[-0.015em] text-t1 md:text-2xl">A practical starting point</p>
            <p className="mt-4 font-dm text-sm leading-[1.7] text-t2">
              Start with scope, ownership and the problem the website or system must solve. The related guides below help you compare platforms, timelines and ongoing responsibilities without pretending one answer fits every business.
            </p>
            <div className="mt-7 flex flex-wrap gap-3">
              <Link href="/services" className="btn-ghost">Explore services</Link>
              <Link href="/work" className="btn-ghost">See delivered work</Link>
            </div>
          </aside>
        </div>
      </PaperBand>
