...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${base}/traditional`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.95 },
    { url: `${base}/interactive`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.7 },
