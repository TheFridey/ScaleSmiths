...
export const PUBLIC_CONTRAST_PAIRS = [
  ...
  { name: "paper ink on paper", fg: "#07111f", bg: "#d4e0eb", largeText: false },
  { name: "paper text on paper", fg: "#1a2d40", bg: "#d4e0eb", largeText: false },
  { name: "paper muted on paper (large/UI)", fg: "#3d556b", bg: "#d4e0eb", largeText: true },
  { name: "paper muted on paper (body)", fg: "#3d556b", bg: "#d4e0eb", largeText: false },
  { name: "paper text on paper-soft", fg: "#1a2d40", bg: "#c5d4e2", largeText: false },
  { name: "acc on paper (link)", fg: "#0c6b82", bg: "#d4e0eb", largeText: false },
  { name: "CTA ink on paper-acc", fg: "#f8fbff", bg: "#0c6b82", largeText: false },
] as const
