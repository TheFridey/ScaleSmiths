...
export function initializeWebMonitoring(env: NodeJS.ProcessEnv = process.env) {
  ...
  try {
    ...
    registerWebErrorMonitoringProvider(createWebSentryMonitoringProvider(sentryFacade()))
...
function sentryFacade(): WebSentryFacade {
  return {
