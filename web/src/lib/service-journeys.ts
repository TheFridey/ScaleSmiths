...
export const serviceJourneys: Record<ServiceJourneySlug, ServiceJourney> = {
  "local-growth": {
    ...
    description: "Websites, visibility and managed improvement for trades, clinics, hospitality businesses, and founder-led local companies that need to be easier to find, trust, and contact.",
    ...
    outcomes: [
      ...
      { title: "Managed improvement", description: "A Digital Growth Partnership can manage measurement, content, conversion work and technical care around the site you already have or a new build." },
    ],
    processTitle: "From first check to ongoing growth",
    process: [
      ...
      { title: "Prioritise the useful work", description: "The recommendation may be a focused repair, clearer content, a growth site, a better booking route, or an ongoing improvement plan." },
    ...
    relatedPages: [
      ...
      { href: "/digital-growth-partnership", label: "Digital Growth Partnership", description: "Ongoing visibility, conversion, content and technical improvement around the digital estate." },
    ],
