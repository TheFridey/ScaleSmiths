...
export const serviceJourneys: Record<ServiceJourneySlug, ServiceJourney> = {
  "local-growth": {
    ...
    description: "Websites and managed improvement for trades, clinics, hospitality businesses, and founder-led local companies that need to be easier to find, trust, and contact.",
    ...
    outcomes: [
      ...
      { title: "Managed improvement", description: "Optional maintenance, measurement, content support, and conversion improvements keep the site useful after launch." },
    ],
    processTitle: "From first check to ongoing improvement",
    process: [
      { title: "Review the current journey", description: "We examine public pages, local signals, mobile contact routes, and the main commercial goal." },
      { title: "Prioritise the useful work", description: "The recommendation may be a focused repair, clearer content, a growth site, or a better booking and enquiry route." },
      { title: "Build and measure", description: "Approved work is delivered with analytics foundations and practical post-launch checks." },
      { title: "Maintain or improve", description: "Ongoing support is optional and scoped separately around maintenance and evidence-backed improvements." },
    ],
    proofSlugs: ["glow-tanning", "csds"],
    proofIntro: "Relevant work for appointment-led and service businesses. Public outcome claims appear only when separately verified.",
    relatedPages: [
