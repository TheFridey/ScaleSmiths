...
export const pricingItems = [
  ...
  { name: "Digital Growth Partnership", range: "Scoped separately", priceClaimId: "price.care-plan", note: "Ongoing visibility, conversion, content, roadmap and technical improvement around the agreed digital estate." },
...
export function buildPricingSchema(baseUrl = "https://scalesmiths.co.uk") {
  return {
    ...
    mainEntity: [
      ...
      {
        "@type": "Question",
        name: "Do you offer Digital Growth Partnerships?",
        acceptedAnswer: { "@type": "Answer", text: "Yes. A Digital Growth Partnership can cover ongoing visibility, conversion, content, roadmap delivery, monitoring and technical support. It can begin around an existing digital estate or follow a ScaleSmiths build." },
      },
    ],
    url: `${baseUrl}/pricing`,
  }
